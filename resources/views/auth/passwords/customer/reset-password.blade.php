		...
		<div>
			<div id="login" class="align-content-center bg-transparent">
				<div class="box_general padding">
					<form id="reset-passwod-form" action="{{route('auth.customers.password.update')}}" method="POST" class="mt-3 mt-sm-2" action="">
						...
						<div class="form-group">
							<input type="email" class="form-control @error('email') is-invalid @enderror" value="{{$email}}"
								name="user_email" id="email" required placeholder="Email">
						...
						<div class="mt-4">
							...
							<a href="{{ route('auth.login') }}" class="btn_1 mt-2 outline full-width float-left">Back to
								Login</a>
						</div>
					</form>
				</div>
